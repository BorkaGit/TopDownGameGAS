...
private:
	...
	void SetEffectProperties(const FGameplayEffectModCallbackData& Data, FEffectPropertiesEnhanced& EffectProperties);
	void ShowFloatingText(TSharedPtr<FEffectPropertiesEnhanced> Props, float Damage);
};
